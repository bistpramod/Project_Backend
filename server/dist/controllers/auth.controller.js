...
const register = async (req, res, next) => {
    try {
        ...
        await (0, emailServer_utils_1.sendEmail)({
            to: user.email,
...
const login = async (req, res, next) => {
    try {
        ...
        if (!isPassMatched) {
            throw new appError_utils_1.default("credentials do not match.", 400);
        }
        ...
        res.cookie("access_token", access_token, {
            httpOnly: env_config_1.default.NODE_ENV !== "development",
            secure: env_config_1.default.NODE_ENV !== "development",
